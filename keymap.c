...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [_FN] = LAYOUT(
        UG_TOGG,  _______,  UG_HUEU,  UG_SATU,  UG_VALU,  UG_HUED,  UG_SATD,  UG_VALD,  _______,  _______,  _______,  KC_VOLD,  KC_VOLU,  _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        _______, TG(_QWER), _______,  _______  ,_______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
    ...
    [_SYM] = LAYOUT(
        ...
        _______,  KC_BSLS,  KC_PERC,  KC_MINS,  KC_UNDS,  _______,  KC_AMPR,  KC_GT,    KC_PLUS, S(KC_GRV), _______,  _______,  _______,                      _______,
